...
description: Analyze code for performance bottlenecks and provide optimization recommendations, focusing on measurable improvements while maintaining code quality and readability. Use when optimizing slow code, improving algorithms, or reducing memory usage.
---
...
1. **Analysis**: List of performance issues found with:
   - Description of the issue
   - Impact (high/medium/low)
   - Time/space complexity

2. **Optimized Code**: Complete optimized version

3. **Improvements Summary**: For each optimization:
   - What was changed
